    ...
    <div class="order-box">
        ...
        if ($result->num_rows > 0) {
            ...
            if ($row["image_of_print"] != "text") {
                ...
                echo "<div class='text-container'>".$row["inscription"]."</div>";
            }
            ...
            if ($row["image_of_print"] == "text"){
                echo "<div class='order-info'>Colour of text: " . $row["inscription_color"] . "</div>";	
            }
