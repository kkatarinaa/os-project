...
<body>
    ...
    <div class = "login-menu" style = "margin-top: 1%; width: 40%; height: 50%">
        <ul class = "autorization" id = "create-menu">
            <form action = "forgot_password.php" method="post" class = "autorization-element-label">
            <li>Логин</li>
            <li><input id = "login" class = "autorization-element-input" type = "text" name = "login"></li>
            <li><button type = "submit" class = "login-button">Отправить пароль</button></li></form>
            ...
            <li><a href = "login_page.php" id = "new-account-link">Войти</a></li>
        </ul>
    </div>
</body>
</html>
